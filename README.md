...
- Clone `android/key.properties.example` and rename to `key.properties` (Please contact email `phandung13122002@gmail.com` or admin to get information in this file.)
